...
public class TransitionBuilder 
{
	...
	/** Permet de générer un objet FadeTransition appliqué à un Pane passé en paramètre, il suffit d'appeler
	 * sur l'objet retourner .play() pour lancer la transition de fase
	 * 
	 ...
	 * @return transition : Objet sur lequel on peut appeler la méthode play() pour lancer l'animation
	 */
