...
public class MailSender {
  ...
  public static void sendMail(Reservation reservation) {
    ...
    try {
      ...
      System.err.println("La facture de la réservation #" + reservation.getId() + " n'a pas pu être envoyée");
      e.printStackTrace();
    }
  }
  ...
  private static MimeBodyPart writeContent(Reservation reservation) {
    String resIDStr = StringEscapeUtils.escapeHtml4(
      ...
      String msgStyled =
        "<div style=\"display:flex;flex-direction:column;align-items:center;background-color:#F4F4F4;padding:50px;font-family:sans-serif;min-height:800px\">" +
